...
public class SendEmail : MonoBehaviour {
    ...
    public void MakeCvsThenSend()
    {
        ...
        mail.Body = "The File attached is the patients data (every entry is seperated by '|') ";
        mail.Attachments.Add(new Attachment(Application.persistentDataPath + "/" + "data.txt"));
